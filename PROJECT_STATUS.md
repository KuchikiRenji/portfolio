...
- **Images**: ✅ Already saved in `public/projects/moshi-voice-assistant/`
  - `architecture.png` ✅
  - `mimi-codec.png` ✅
...
- **Images**: ⚠️ Folder created, awaiting images
  - Folder: `public/projects/salty-dream-bot/` ✅ Created
  - `generated.png` ⏳ Needs to be saved manually
...
- 16 real projects:
  ...
  2. Open Recommender (Dec 2023 – Feb 2024)
  3. Demand Forecasting (Nov 2024 – Jan 2025)
  4. UNMISSABLERP (Oct 2025 – Nov 2025)
  5. Customer Segmentation (Nov 2024 – Mar 2025)
  6. Argo CD Rollout Patterns (Sep 2024 – Dec 2024)
  7. E2E AI Chatbot (Oct 2023 – Feb 2024)
  8. Rule-based LLMs (Oct 2024 – Feb 2025)
  9. X Customer Support Chatbot (Apr 2025 – Jun 2025)
  10. AI Medical Chatbot (Aug 2023 – Nov 2023)
  11. Moshi Voice Assistant (Sep 2024 – Dec 2024)
  12. Salty Dream Bot (Dec 2022 – Mar 2023)
  13. VALL-E TTS (Jan 2023 – Mar 2023)
  14. Admin Issuer Portal (Dec 2025 – Jan 2026)
  15. Rising Dot Agency (Dec 2025 – Jan 2026)
...
- **Images**: ⚠️ Folder created, awaiting image
  - Folder: `public/projects/vall-e-tts/` ✅ Created
...
- **Images**: ⚠️ Folder created, awaiting images
  - Folder: `public/projects/admin-issuer-portal/` ✅ Created
  - `dashboard.png` ⏳ Needs to be saved manually (first screenshot you provided)
...
- **Period**: Dec 2025 – Jan 2026
- **Images**: ⚠️ Folder created, awaiting images
  - Folder: `public/projects/rising-dot-agency/` ✅ Created
  - `hero.png` ⏳ Needs to be saved manually (first screenshot - hero section)
  - `portfolio.png` ⏳ Needs to be saved manually (second screenshot - portfolio section)
...
- **Images**: ⚠️ Folder created, awaiting images
  - Folder: `public/projects/solana-bundler/` ✅ Created
  - `wallet-management.png` ⏳ Needs to be saved manually (first screenshot)
  - `fund-wallets.png` ⏳ Needs to be saved manually (second screenshot)
  - `token-deployment.png` ⏳ Needs to be saved manually (third screenshot)
  - `architecture.png` ⏳ Needs to be saved manually (fourth screenshot - architecture diagram)
...
4. **Admin Issuer Portal** - Needs 2 images (dashboard and signature editor screenshots) to be saved manually
5. **Rising Dot Agency** - Needs 3 images (hero, portfolio, and SEO tools screenshots) to be saved manually
6. **Solana Bundler** - Needs 4 images (wallet management, fund wallets, token deployment, and architecture) to be saved manually

Total: 38 projects (24 placeholders + 16 real projects)
